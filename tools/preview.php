...
{
if ($filesize > 1) {
        echo "<center>Предварительный просмотр</center><br><center>Предварительный просмотр недоступен,  картинка слишком большого размера</center></td></tr>";
	}
else {
        echo "<center>Предварительный просмотр</center><br><center><img title='".$imya_fayla."' alt='".$imya_fayla."' src=\"" .$scripturl. "download2.php?a=" . $filecrc . "&b=" . md5($foundfile[2].$_SERVER['REMOTE_ADDR']) . "\" width=\"400px\"></center>";
	 }
}
